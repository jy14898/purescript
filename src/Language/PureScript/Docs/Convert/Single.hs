...
getDeclarationTitle (P.TypeInstanceDeclaration _ _ _ name _ _ _ _ _) = Just (P.showIdent name)
...
-- TODO Check. Presumably they dont want to include the forall anyway, and this isn't necessary
--      for actual execution/compilation
